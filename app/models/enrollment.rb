  ...
  def self.types_with_indefinite_article
    {
      ...
      'StudentEnrollment' => t('#enrollment.roles.student_with_indefinite_article', "A User"),
      'StudentViewEnrollment' => t('#enrollment.roles.student_with_indefinite_article', "A User"),
